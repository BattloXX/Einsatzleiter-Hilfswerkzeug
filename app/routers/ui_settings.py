...
@router.get("/settings/wetter", response_class=HTMLResponse)
...
async def weather_station_remove(
    ...
    return RedirectResponse(f"/admin/settings/wetter{org_suffix}#wetterstation", status_code=303)
