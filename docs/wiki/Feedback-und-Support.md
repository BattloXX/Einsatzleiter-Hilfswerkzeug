...
1. **Was hast du erwartet?** – Beschreibe das gewünschte Verhalten.
2. **Was ist stattdessen passiert?** – Beschreibe das tatsächliche Verhalten.
3. **Schritte zum Nachvollziehen** – Wie reproduzierst du den Fehler?
...
Du hast eine Idee für eine neue Funktion oder Verbesserung?

1. **Beschreibe das Problem** – Was fehlt dir heute?
2. **Beschreibe die gewünschte Lösung** – Wie sollte es funktionieren?
